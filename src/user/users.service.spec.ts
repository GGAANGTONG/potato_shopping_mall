...
describe('UsersService', () => {
  ...
  it('5-3. User - update, nickname과 profile 둘다 작성하지 않아 변경 사항이 없어서 에러 반환(Patch 요청이라 globalValidationPipe를 탈지 않탈지 모르겠음, 그래서 validationPipe로직은 제외함 - 이건 put에 맵핑돼야 되는 dto임)', async () => {
    const id = 1;
